...
const RegisterForm: React.FC = () => {
  ...
  return (
    <div className="relative flex flex-col w-full max-w-[447px] bg-[#050505] border-[#97979733] border-1 rounded-[32px] items-center justify-center p-6 sm:p-8 md:p-10">
      <div className="w-full mb-6 mt-4 px-4">
      ...
      <div className="flex flex-col items-center justify-center w-full gap-4">
        ...
        <div className="w-full flex justify-center px-4">
          ...
          >
            <p className="font-semibold text-xl sm:text-2xl m-0 mb-1">Register </p>
        ...
        <div className="w-full text-center mt-4 mb-4">
          <p className="text-[#f5f5f5] text-sm m-0">
            ...
            <span>
              <a href="/login" className="text-[#05E1C6] hover:underline">
                Log in Here{" "}
              </a>
            </span>
          </p>
